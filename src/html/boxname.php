        ...
        <div class="flexlist block">
            <div class="flexitem">
                ...
                <div class="item single">
                    <div class="details info"><br>Das <?php print $w48_config['w48_Name']; ?> wird in Ihrem Heimnetz unter einem Standardnamen angezeigt. Wenn Sie möchten, können Sie dem <?php print $w48_config['w48_Name']; ?> hier einen individuellen Namen geben.<br>
 Dieser Name wird dann im Heimnetz für die Benennung folgender Funktionen verwendet:</div>
<div class="details info">WLAN-Netzwerk</div>
<div class="details info">Heimnetzfreigabe</div>
<div class="details info">Mediaserver</div>
                </div>
                <br>
                <div class="header">
